...
export default function OnboardingStep13() {
  ...
  return <div className="min-h-screen bg-background pb-24">
      {/* Progress Bar */}
      <OnboardingProgress currentStep={13} totalSteps={13} />
        ...
        <div className="max-w-7xl mx-auto">
          ...
          {selectedPlan && selectedChef && selectedMealsForPreview.length > 0 && (
            ...
            <div className={cn(
              ...
              selectedMealsForPreview.length === 3 && "grid-cols-1 sm:grid-cols-2 md:grid-cols-3",
              selectedMealsForPreview.length >= 4 && "grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4"
            )}>
